defmodule Inskedular.Router do
  ...
  alias Inskedular.Scheduling.Commands.{CreateSchedule,UpdateSchedule,DestroySchedule,StartSchedule,RestartSchedule,StopSchedule,IncludeMatchesInSchedule,CreateTeam,UpdateTeam,DestroyTeam,CreateMatch,UpdateMatch,DestroyMatch}
  ...
  dispatch [CreateSchedule,UpdateSchedule,DestroySchedule,StartSchedule,RestartSchedule,StopSchedule,IncludeMatchesInSchedule], to: Schedule, identity: :schedule_uuid, lifespan: ScheduleLifespan
