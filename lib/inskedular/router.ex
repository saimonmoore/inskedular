defmodule Inskedular.Router do
  ...
  alias Inskedular.Scheduling.Commands.{CreateSchedule,UpdateSchedule,DestroySchedule,StartSchedule,IncludeMatchesInSchedule,CreateTeam,UpdateTeam,DestroyTeam,CreateMatch,UpdateMatch}
  ...
  dispatch [CreateSchedule,UpdateSchedule,DestroySchedule,StartSchedule,IncludeMatchesInSchedule], to: Schedule, identity: :schedule_uuid, lifespan: ScheduleLifespan
