defmodule Inskedular.Router do
  ...
  alias Inskedular.Scheduling.Commands.{CreateSchedule,StartSchedule,IncludeMatchesInSchedule,CreateTeam,CreateMatch}
  ...
  dispatch [CreateMatch], to: Match, identity: :match_uuid
end
